      ...
      <div className="min-h-screen bg-[#EEEEEE] flex items-center justify-center p-6">
        ...
        <div className="bg-white rounded-lg border border-[#EEEEEE] p-8 max-w-md w-full text-center">
          ...
          <p className="text-base text-[#595959] font-roboto mb-6" style={{ fontWeight: 400 }}>
            Your marketing request has been sent to the VA team. You will be notified once work begins.
          </p>
          <button
  ...
  return (
    ...
    <div className="min-h-screen bg-[#EEEEEE] pb-32">
      ...
      <div className="p-6 lg:p-8">
        {/* Error Message */}
        {error && (
          <div className="w-full mx-auto mb-6 bg-white rounded-lg border-2 border-red-200 p-4 flex items-start gap-3">
