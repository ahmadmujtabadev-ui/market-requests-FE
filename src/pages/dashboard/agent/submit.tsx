...
type UploadedFile = {
  ...
  size: number;
  type: string;
  preview?: string; // blob URL just for UI
};
...
export default function SubmitRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      formData.append(
        'platforms',
        JSON.stringify(finalPlatforms.filter(Boolean))
      );
      ...
      // attach files under the "files" field name
      files.forEach((f) => {
          ...
          <div className="w-full mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex items-center flex-1">
                <div
                  className={`w-10 h-10 rounded-full flex items-center justify-center text-sm font-manrope transition-all ${
                    currentStep >= 1
                      ? 'bg-black text-white'
              ...
              <div
                className={`h-0.5 flex-1 mx-4 ${
                  currentStep >= 2 ? 'bg-black' : 'bg-[#EEEEEE]'
                }`}
              />
              ...
              <div
                className={`h-0.5 flex-1 mx-4 ${
                  currentStep >= 3 ? 'bg-black' : 'bg-[#EEEEEE]'
                }`}
              />
        ...
        <div className="p-6 lg:p-8">
          <div className="w-full mx-auto space-y-6">
            {currentStep === 1 && (
              <>
                <div className="bg-white rounded-lg border border-[#EEEEEE] p-6">
                  ...
                  {selectedTemplate ? (
                    <div className="mt-3 flex items-center gap-2 text-sm text-[#595959] font-roboto" style={{ fontWeight: 400 }}>
                      ...
                      >
                        {selectedTemplate.type === 'residential'
                          ? 'Residential'
                          : 'Commercial'}
                      </span>
                      <span>•</span>
                ...
                <div className="bg-white rounded-lg border border-[#EEEEEE] p-6">
                  ...
                  />
                  <p
                    className="mt-2 text-xs text-[#595959] font-roboto"
                    style={{ fontWeight: 400 }}
                  >
            ...
            {currentStep === 2 && (
              <div className="bg-white rounded-lg border border-[#EEEEEE] p-6">
                <h3
                  className="text-lg text-black font-manrope mb-1"
                  style={{ fontWeight: 700 }}
                >
                  TIMELINE & USAGE
                </h3>
                ...
                <div className="mb-6">
                  <label
                    className="block text-sm text-black font-roboto mb-3"
                ...
                <div className="mb-6">
                  <label
                    ...
                    style={{ fontWeight: 500 }}
                  >
                    Where will you use this template?{' '}
                  ...
                  <div className="space-y-2">
                    {[
                      ...
                      <label key={option} className="flex items-center">
                        ...
                        />
                        <span
                          className="ml-2 text-sm text-black font-roboto"
                          style={{ fontWeight: 400 }}
                        >
                          {option}
                        </span>
              ...
              <>
                ...
                <div className="bg-white rounded-lg border border-[#EEEEEE] p-6">
                  ...
                  >
                    ...
                    <p
                      className="text-sm text-black font-manrope mb-2"
                      style={{ fontWeight: 700 }}
                    >
                    ...
                    <p
                      className="mt-4 text-xs text-[#595959] font-roboto"
                      style={{ fontWeight: 400 }}
                    >
                ...
                <div className="bg-white rounded-lg border border-[#EEEEEE] p-6">
                  ...
                  <label className="flex items-start cursor-pointer">
                    ...
                    <span
                      ...
                      style={{ fontWeight: 400 }}
                    >
                      I confirm that all details are correct and understand that
                      turnaround time may vary based on request volume
                    </span>
                  </label>
                </div>
              </>
