...
const AddCategoryModal: React.FC<AddCategoryModalProps> = ({
  ...
  const validateForm = () => {
    ...
    if (canvaUrl && !canvaUrl.includes("canva.com")) {
      newErrors.canvaFolderUrl = "Invalid Canva URL (must contain canva.com)";
    }
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black/10 font-roboto ${
            ...
            <div>
              ...
              <input
                ...
                id="canvaFolderUrl"
                name="canvaFolderUrl"
                value={formData.canvaFolderUrl}
                onChange={handleChange}
                className={`w-full px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-black/10 font-roboto ${
                  errors.canvaFolderUrl ? "border-red-500" : "border-[#EEEEEE]"
                }`}
                placeholder="https://www.canva.com/folder/..."
                disabled={isLoading}
              />
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        if (isEdit && templateId) {
          ...
          if (firstFile) fd.append("previewUrl", firstFile);
          ...
          files.forEach((file) => fd.append("previewUrl", file));
          ...
          <div className="w-full mx-auto">
            ...
            <form onSubmit={formik.handleSubmit}>
              <div className="bg-white rounded-lg border border-[#EEEEEE] p-6 mb-6">
                ...
                <div className="mb-6">
                  <label htmlFor="title" className="block text-sm text-black font-manrope mb-2" style={{ fontWeight: 700 }}>
                    Template Title *
                  </label>
                  <input
                    type="text"
                    ...
                    className={`w-full px-4 py-3 border rounded-lg text-sm font-roboto focus:outline-none focus:ring-2 focus:ring-black/10 ${
                      formik.touched.title && formik.errors.title ? "border-red-500" : "border-[#EEEEEE]"
                    }`}
                    style={{ fontWeight: 400 }}
                  />
                  {formik.touched.title && formik.errors.title && (
                    <p className="text-sm text-red-600 font-roboto mt-1" style={{ fontWeight: 400 }}>
                      {formik.errors.title}
                    </p>
                  )}
                </div>
                ...
                <div className="mb-6">
                  <div className="flex items-center justify-between mb-2">
                    <label htmlFor="categoryId" className="block text-sm text-black font-manrope" style={{ fontWeight: 700 }}>
                      Category *
                    </label>
                    <button
                      type="button"
                  ...
                  <select
                    ...
                    className={`w-full px-4 py-3 border rounded-lg text-sm font-roboto appearance-none bg-white focus:outline-none focus:ring-2 focus:ring-black/10 ${
                      formik.touched.categoryId && formik.errors.categoryId ? "border-red-500" : "border-[#EEEEEE]"
                    }`}
                    style={{ fontWeight: 400 }}
                  >
                    <option value="">
                  ...
                  {!previewImages.length ? (
                    ...
                    <div className="relative border border-[#EEEEEE] rounded-lg p-4">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-roboto text-black mb-1" style={{ fontWeight: 500 }}>
                            selected
                          </p>
                          <p className="text-xs text-[#595959] font-roboto" style={{ fontWeight: 400 }}>
